...
## Tehvävätilanne 6.4.2023

Tehtäviä tehty tehtäväsarjat 1-9.

Kokonaispisteitä voi saada 153. Tällä hetkellä tehty 100/153 pistettä eli 65,36 %
...
Näistä tehtävistä tehty 11/19 pistettä.

--------------------------------------------------------------------------------------------------------------------------------------

Harjoitukset 9 - GraphQL

MongoDBn kanssa ongelmia osassa tehtävistä, joten ei ihan onnistunut varmaankaan tehtävänannon mukaan mutta yritetty on.
...
- Mielestäni toimii ainakin osittain, vähän yhteys katkesi MongoDBn välillä. Enemmän oman koneen kanssa ongelmaa kuin tehtävien ymmärtämisessä ja tekemisessä 3/5 pistettä antaisin.


2. Testaa kyselyjen toimivuus Apollo Playgroundin avulla. [2p]
- Tämä toimi osittain 1/2 pistettä.

3. Toteuta mutaatio albumin poistamista varten. Testaa mutaatiota Apollo Playgroundista. [5p]
- Tämä toimi kanssa osittain. 3/5
...
- Tämän kanssa oli ongelmaa, että en ihan ymmärtänyt kuinka se tehdään. Osan sain poisettua. 3/6 pistettä.

Antaisin näistä 10/18.
